...
public class QKanbanItem extends EntityPathBase<KanbanItem> {
    ...
    public final DateTimePath<java.time.LocalDateTime> kbEndDate = createDateTime("kbEndDate", java.time.LocalDateTime.class);
    ...
    public final DateTimePath<java.time.LocalDateTime> kbStartDate = createDateTime("kbStartDate", java.time.LocalDateTime.class);
